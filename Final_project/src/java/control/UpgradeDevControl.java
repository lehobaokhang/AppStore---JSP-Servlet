...
@WebServlet(name = "UpgradeDevControl", urlPatterns = {"/upgradedev"})
public class UpgradeDevControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpgradeDevControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
