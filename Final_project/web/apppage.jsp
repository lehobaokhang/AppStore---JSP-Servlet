        ...
        <div class="container game-page-home">
            ...
            <section class="text-center mb-4">
                ...
                <div class="d-flex justify-content-between">
                    <h4 class="">All Apps</h4>
                    <a href="productcollection?category=1&collection=1" class="btn btn-see-more">See more</a>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="productcollection?category=1&collection=2" class="btn btn-see-more">See more</a>
                </div>
                <!--Grid row-->
                <div class="row wow fadeIn">
                    <!--Grid column-->
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="productcollection?category=1&collection=3" class="btn btn-see-more">See more</a>
                </div>
                <div class="row wow fadeIn">
                    <!--Grid column-->
                    <c:forEach begin="0" end="3" var="i">
